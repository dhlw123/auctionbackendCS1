...
public class ItemStatusService {
  ...
  /**
   * Kiểm tra xem phiên đấu giá của sản phẩm đã kết thúc hoặc bị hủy hay chưa. Nếu thời gian kết
   * thúc đã trôi qua so với hiện tại, hệ thống sẽ tự động cập nhật trạng thái thành "ENDED".
   *
  ...
  public boolean auctionEndedOrNot(Long itemId) {
    ...
    // Nếu đã qua thời gian kết thúc dự kiến nhưng trạng thái chưa cập nhật, đổi sang ENDED và lưu
    // lại DB
