...
/**
 * Thực thể RevokedToken lưu trữ thông tin các token đã bị thu hồi hoặc danh sách người dùng bị cấm (banned).
 * Dùng để kiểm tra tính hợp lệ của token JWT đã phát hành trước đó.
 */
@Entity
